...
class CNN_MGVLF(nn.Module):
    ...
    def __init__(self, backbone, transformer, DE, position_encoding,
        ...
        # nếu dùng QABM thì input vào conv6_1 đã ép về hidden_dim, ngược lại vẫn là 2048
        in_c6 = hidden_dim if self.use_qabm else 2048
        self.conv6_1 = nn.Conv2d(in_channels=in_c6, out_channels=128, kernel_size=1, stride=1)
